...
mod tests {
    ...
    // NOTE: test_build_pq_model_l2 and test_build_pq_model_cosine have been moved to
    // integration tests (tests/vector_index/pq_model.rs) because they are slow and
    // benefit from running with optimization enabled.
