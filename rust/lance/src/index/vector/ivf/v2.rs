...
mod tests {
    ...
    // NOTE: test_build_ivf_pq, test_build_ivf_pq_v3, and test_build_ivf_pq_4bit have been
    // moved to integration tests (tests/vector_index/ivf_pq.rs) because they are slow
    // and benefit from running with optimization enabled.
    ...
    // NOTE: test_create_ivf_hnsw_pq and test_create_ivf_hnsw_pq_4bit have been moved to
    // integration tests (tests/vector_index/ivf_hnsw.rs) because they are slow and benefit
    // from running with optimization enabled.
    ...
    // NOTE: test_optimize_with_empty_partition, test_create_index_with_many_invalid_vectors,
    // and test_remap_join_on_second_delta have been moved to integration tests
    // (tests/vector_index/lifecycle.rs and tests/vector_index/ivf_pq.rs) because they are
    // slow and benefit from running with optimization enabled.
    // test_spfresh_join_split was NOT moved because it requires private API access.
